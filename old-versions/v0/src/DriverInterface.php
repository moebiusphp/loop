...
interface DriverInterface {
    ...
    /**
     * Run one iteration of the event loop. The driver decides
     * if it should start with sleeping to conserve CPU, for
     * example if it is only waiting for a timer or IO event.
     */
